...
void tms57002_device::decode_error(u32 opcode)
{
	...
	bprintf(PRINT_ERROR, _T("tms57002: %06x - Contact Mamedev\n"), opcode);
}
...
#undef CDEC1
	...
	default:
		bprintf(PRINT_ERROR, _T("Unhandled cat1 opcode %02x\n"), opcode >> 18);
		decode_error(opcode);
		break;
	}
}
...
#undef CDEC2A
	...
	default:
		bprintf(PRINT_ERROR, _T("Unhandled cat2_pre opcode %02x\n"), (opcode >> 11) & 0x7f);
		decode_error(opcode);
		break;
	}
}
...
#undef CDEC2B
	...
	default:
		bprintf(PRINT_ERROR, _T("Unhandled cat2_post opcode %02x\n"), (opcode >> 11) & 0x7f);
		decode_error(opcode);
		break;
	}
}
...
#undef CDEC3
	...
	default:
		bprintf(PRINT_ERROR, _T("Unhandled cat3 opcode %02x\n"), (opcode >> 11) & 0x7f);
		decode_error(opcode);
		break;
	}
}
