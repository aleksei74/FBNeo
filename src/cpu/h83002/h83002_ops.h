...
static INT32 h8_execute(h83xx_state *h8, INT32 run_cycles)
{
	UINT16 opcode=0;
...
static void h8_group5(h83xx_state *h8, UINT16 opcode)
{
	...
	case 0x6:
		...
		if(opcode == 0x5670)
		{
			...
			{
				UINT32 sp = h8_getreg32(h8, H8_SP);
				UINT16 frame = h8_mem_read16(h8, sp);

				udata8 = frame >> 8;
				udata32 = ((frame & 0xff) << 16) | h8_mem_read16(h8, sp + 2);
				h8_setreg32(h8, H8_SP, sp + 4);
